...
RegisterServerEvent('esx_favagas:getItem')
AddEventHandler('esx_favagas:getItem', function()
...
RegisterServerEvent('esx_favagas:sell')
AddEventHandler('esx_favagas:sell', function()
